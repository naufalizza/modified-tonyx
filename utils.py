...
tokenizer = XLMRobertaTokenizer.from_pretrained("deepset/xlm-roberta-base-squad2-distilled")
# tokenizer = XLMRobertaTokenizer.from_pretrained("sentence-transformers/xlm-r-distilroberta-base-paraphrase-v1")
# tokenizer = XLMRobertaTokenizer.from_pretrained("lxyuan/distilbert-base-multilingual-cased-sentiments-student")
# tokenizer = XLMRobertaTokenizer.from_pretrained("joaobarroca/distilbert-base-uncased-finetuned-massive-intent-detection-english")
# tokenizer = XLMRobertaTokenizer.from_pretrained("dardem/mdistilbert-base-cased-uk-toxicity")
